...
- Pinterest-style card grid (responsive)
- Each card displays an image + title
- Clicking a card opens a dedicated page with PDF viewer
- Real-time search by title or tags
- Customizable tags for categorizing pins
